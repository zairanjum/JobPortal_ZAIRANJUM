...
exports.mail = () => sgMail.setApiKey(process.env.SENDGRID_API_KEY);
    ...
    <body>
      ...
      >
        <div style="margin: 50px auto; width: 70%; padding: 20px 0">
          ...
          >
            <p>TitforTat</p>
            <p>Rizwan Block Saeed Colony Faisalabad</p>
            <p>Pakistan</p>
          </div>
        </div>
      </div>
...
exports.generateVerificationTokenTemplate = (otp) => {
  return `
  <!DOCTYPE html>
  <html lang="en">
    <head>
    ...
    <body>
      ...
      >
        <div style="margin: 50px auto; width: 70%; padding: 20px 0">
          ...
          <p style="font-size: 1.1em">Hi,</p>
          <p>
            You Have requested for OTP. Use the following OTP to
            verify yourself. OTP is valid for 5 minutes
          </p>
          <h2
            style="
