...
import { CreateFreelancerProfile } from "../../../redux/actions/FreelancerActions";
...
const CreateProfile = () => {
  ...
  const onSubmit = async (formValues) => {
    dispatch(CreateFreelancerProfile(params.id, formValues, navigate, toast));
  };
  ...
  const validate = Yup.object({
    ...
    Description: Yup.string()
      .min(200, "Description must have at least 200 words")
                          ...
                          <div className="grid grid-cols-6 gap-4 ">
                            <div className="col-span-6 sm:col-span-4 ">
                              ...
                              <Field
                                type="text"
                                name="Title"
                                placeholder="Frontend Developer | HTML |CSS | JavaScript |Data Entry "
