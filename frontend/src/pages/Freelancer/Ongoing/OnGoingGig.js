...
const OngoingGig = () => {
  ...
  const singleOrderId = gigOrder?._id;
  ...
  const [days, setDays] = useState(
    sessionStorage.getItem(`gigDaysFreelancer-${singleOrderId}`) || duration
  );
  const [hours, setHours] = useState(
    sessionStorage.getItem(`gigHoursFreelancer-${singleOrderId}`) || 0
  );
  const [minutes, setMinutes] = useState(
    sessionStorage.getItem(`gigMinutesFreelancer-${singleOrderId}`) || 0
  );
  const [seconds, setSeconds] = useState(
    sessionStorage.getItem(`gigSecondsFreelancer-${singleOrderId}`) || 0
  );

  useEffect(() => {
    sessionStorage.setItem(`gigDaysFreelancer-${singleOrderId}`, days);
    sessionStorage.setItem(`gigHoursFreelancer-${singleOrderId}`, hours);
    sessionStorage.setItem(`gigMinutesFreelancer-${singleOrderId}`, minutes);
    sessionStorage.setItem(`gigSecondsFreelancer-${singleOrderId}`, seconds);
  ...
  }, [days, hours, minutes, seconds, singleOrderId]);
