...
import { SubmitExchangeSkillRequest } from "../../../redux/actions/FreelancerActions";
...
const SendRequestForm = () => {
  ...
  const formData = {
    exchangeSkillsId: singleExchangeSkill._id,
    recentExperience: "",
    duration: "",
    coverLetter: "",
    bid: "",
  ...
  const onSubmit = (formValues) => {
    dispatch(SubmitExchangeSkillRequest(formValues, navigate, toast));
  };
        ...
        <div className="item w-full lg:w-1/2  h-auto flex-grow border border-3 lg:rounded-l-md border-r-1  border-gray-300 py-2">
          <div className="item w-full h-auto flex-grow px-6 space-y-2 ">
            ...
            <div className="item w-full h-auto flex-grow ">
              <h2 className="text-xl font-medium tracking-tight text-gray-900 mb-4">
                {singleExchangeSkill?.title}
              </h2>
            </div>

            <div className="item w-full h-auto flex-grow text-sm text-gray-500 ">
              <p>Posted On {dateConverter(singleExchangeSkill?.createdAt)}</p>
            </div>
            <div className="item w-full h-auto flex-grow">
              <div className="flex items-center text-sm font-semibold text-sky-500 space-x-1">
                ...
                <span className=" text-sm text-gray-500">
                  {singleExchangeSkill?.freelancer?.address?.country}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="item w-full h-auto flex-grow px-6 ">
            <p className="font-medium text-gray-700 my-2">
              {singleExchangeSkill?.discription}
            </p>
          </div>
          ...
          <div className="item w-full h-auto flex-grow px-6 mt-2 mb-3 space-y-2">
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                {singleExchangeSkill?.tags?.map((tag, index) => (
                  <div
                    key={index}
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                <div className=" px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md ">
                  <span>
                    Required Skill: {singleExchangeSkill?.requiredSkills}
                  </span>
                </div>
                <div className="px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md">
                  <span>
                    Offered Skill: {singleExchangeSkill?.offeredSkills}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
            <div className="item">
              <div className="flex px-2 py-2 text-sm font-thin text-gray-700 bg-gray-300 rounded-md ">
                ...
                <span className="-mt-1">
                  Duration: {singleExchangeSkill?.duration} days
                </span>
              </div>
            </div>
            ...
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  {" "}
                  Beginner Price: ${singleExchangeSkill?.price?.beginnerLevel}
                </span>
              </div>
            </div>
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  Intermediate Price: $
                  {singleExchangeSkill?.price?.intermediate}
                </span>
              </div>
            </div>
            ...
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  Expert Price: ${singleExchangeSkill?.price.expert}
                </span>
              </div>
            </div>
          </div>
                            ...
                            >
                              <div className="flex flex-row space-x-4 ">
                                <div className="item  basis-full">
                                  ...
                                  >
                                    Include a link to your GitHub profile and/or
                                    website
                                  </label>
                                  <Field
