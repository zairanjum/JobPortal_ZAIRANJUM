...
import { DeleteExchangeSkill } from "../../../redux/actions/FreelancerActions";
        ...
        <div className="item w-full lg:w-1/4 h-auto border-3 border lg:rounded-r-md border-l-1 lg:border-l-0 border-gray-300 ">
          <div className="item w-full h-auto flex-grow px-6 my-4 ">
            <Link
              ...
              state={{ myExchangeSkill: singleExchangeSkill }}
            >
            ...
            <div className="item w-full h-auto flex-grow px-6 my-4 "></div>
            ...
            {deleteModal && (
              <Modal
                ...
                del={() => deleteExchangeSkill(_id)}
                comment={"Exchange Skill"}
                message={"Exchange Skill"}
              />
            )}
          </div>
