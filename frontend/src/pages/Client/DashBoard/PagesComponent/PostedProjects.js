...
import { GetAllJobs, DeleteJob } from "../../../../redux/actions/ClientActions";
...
const PostedProjects = () => {
  ...
  const jobs = useSelector((state) => state?.clientData?.jobs?.response);
      ...
      {loading ? (
        ...
        <div className="container  mx-auto grid">
          <div className="flex flex-row flex-wrap  items-center justify-between mb-4">
            <Title title="Posted Projects" />
            <Link to="/client/create-project">
              <button className="h-8 flex items-center justify-between px-2 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-md active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal">
                <svg
          ...
          {jobs && jobs.length > 0 ? (
            <div className="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <tr key={index} className="text-gray-700">
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center space-x-4 text-sm">
                              <Link to="/client/edit-project" state={{ job }}>
                                <button
              ...
              <Pagination
                freelancersPerPage={projectsPerPage}
                totalFreelancers={jobs?.length}
                paginate={paginate}
