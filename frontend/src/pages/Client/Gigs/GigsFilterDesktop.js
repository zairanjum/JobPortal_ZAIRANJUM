...
const GigsFilterDesktop = () => {
  ...
  const [filterGig, setFilterGig] = useState([]);
  ...
  function hasGigs(gigs, indexOfFirstFreelancer, indexOfLastFreelancer) {
    const currentGigs = filterGig?.slice(
                  ...
                  <div className=" mt-4">
                    ...
                    <div>
                      <Pagination
                        ...
                        totalFreelancers={filterGig?.length}
                        paginate={paginate}
                ...
                <div className="rounded-md border-3 border border-gray-300 lg:h-full mt-2">
                  <div className="mx-4 mt-4">
                    <div className="flex justify-center w-full">
                      <EmptyState message="No Gigs To Show " />
                    </div>
                  </div>
                </div>
              </div>
...
export default GigsFilterDesktop;
