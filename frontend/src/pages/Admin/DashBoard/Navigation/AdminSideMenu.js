  ...
  return (
    <div>
      ...
      >
        ...
        >
          <svg
            className="shrink-0 w-6 h-5 mr-2 text-teal-600 transition group-hover:text-gray-900"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        <Link
          className="flex items-center px-4 py-3 transition cursor-pointer group  hover:text-gray-900"
          to="exchange-skills-request-list"
        >
          <svg
            className="shrink-0 w-5 h-5 mr-2 text-teal-600 transition group-hover:text-gray-900"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span>Exchange Skills Request</span>
        </Link>
        <Link
          className="flex items-center px-4 py-3 transition cursor-pointer group  hover:text-gray-900"
          to="orders-list"
        ...
        >
          ...
          <span>All Freelancers Reviews</span>
        </Link>
