...
const ExchangeSkillsOrderDetails = () => {
  const { exchangeSkillsOrder } = useLocation()?.state;
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {dateConverter(exchangeSkillsOrder?.createdAt)}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {" "}
                    {exchangeSkillsOrder?.exchangeSkillsOrderType.duration} days
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {exchangeSkillsOrder?.exchangeSkillsOrderType?._id}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {exchangeSkillsOrder?.freelancer?._id}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {
                      exchangeSkillsOrder?.exchangeSkillsOrderType?.submittedBy
                        ?.firstName
                    }
                    {
                      exchangeSkillsOrder?.exchangeSkillsOrderType?.submittedBy
          ...
          <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
            ...
            <div className="item">
              <div className="flex px-2 py-2 text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  Status: {exchangeSkillsOrder?.exchangeSkillsOrderType?.status}
                </span>
              </div>
            </div>
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  $ {exchangeSkillsOrder?.exchangeSkillsOrderType?.bid}
                </span>
              </div>
            </div>
          </div>
...
export default ExchangeSkillsOrderDetails;
