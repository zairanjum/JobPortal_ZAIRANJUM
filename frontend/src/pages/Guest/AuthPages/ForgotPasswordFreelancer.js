...
import { ForgetFreelancerPassword } from "../../../redux/actions/FreelancerActions";
import Spinner from "./Spinner";

const ForgotPasswordFreelancer = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const onSubmit = async (email) => {
    dispatch(ForgetFreelancerPassword(email, navigate, toast));
  };
...
export default ForgotPasswordFreelancer;
