...
import { LoginFreelancer } from "../../../redux/actions/FreelancerActions";
...
const SignInFreelancer = () => {
  ...
  const onSubmit = (formData) => {
    ...
    dispatch(LoginFreelancer(userData, navigate, toast));
  };
          ...
          <>
            <div className="w-full py-6 mx-auto md:w-3/5 lg:w-2/5 ">
              <h1 className=" text-3xl font-medium text-center text-gray-800 md:text-3xl mb-6">
                Log in to TitforTat as Freelancer
              </h1>
