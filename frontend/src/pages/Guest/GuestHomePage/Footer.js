          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center text-white sm:justify-start">
                <Link
                  to="/"
                  className="logo text-md md:text-2xl font-bold text-white"
                >
                  <img
                    src={clap}
              ...
              <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-left">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-white">Our Categories</p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    <div className="flex items-center justify-center gap-1.5 sm:justify-start">
                      ...
                      <span className="text-white">zairanjum66@gmail.com</span>
                    </div>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="text-white">03017232755</span>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                    ...
                    <address className="-mt-0.5 not-italic text-white">
                      Rizwan Block Saeed Colony, Faisalabad, Pakistan
                    </address>
                  </li>
                </ul>
              </div>
